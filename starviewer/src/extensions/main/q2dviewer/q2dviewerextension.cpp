...
#ifdef STARVIEWER_LITE
    leftButtonExclusiveTools << "ZoomTool" << "SlicingTool" << "TranslateLeftTool" << "DistanceTool" << "PerpendicularDistanceTool" << "EraserTool";
#else
    leftButtonExclusiveTools << "ZoomTool" << "SlicingTool" << "TranslateLeftTool" << "PolylineROITool" << "DistanceTool" << "PerpendicularDistanceTool"
